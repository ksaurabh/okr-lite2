                ...
                <div className="flex items-center gap-3 text-xs text-gray-500">
                  {owner && (
                    <span className="flex items-center gap-1.5">
                      <span className="w-4 h-4 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-[10px] font-bold">O</span>
          ...
          <div className="flex items-center gap-1 ml-4">
            ...
            {canModify && (
              <>
                ...
                <Button variant="ghost" size="sm" onClick={() => cloneObjective(objective.id, { orgId: organization?.id || '', userEmail, shared: objective.shared })} title="Clone objective">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
